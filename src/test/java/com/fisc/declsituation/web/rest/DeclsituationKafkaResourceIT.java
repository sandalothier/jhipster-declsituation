...
public class DeclsituationKafkaResourceIT {
    ...
    @Autowired
    private DeclsituationKafkaProducer producer;

    @Autowired
    private DeclsituationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclsituationKafkaResource kafkaResource = new DeclsituationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declsituation-kafka/publish?message=test"))
